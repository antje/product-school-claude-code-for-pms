...
- **Acceptance rate** — headline metric: share of offers accepted vs.
...
90s→60s, and console filter persistence. Since then, callout-related
...
- The acceptance-rate dip is not a gradual seasonal drift. Weekly data
  shows a sharp step down (77%→54%) exactly the week 4.2 shipped, recovering
