...
points, and only people with points get offers. But decay is slow, roughly
0.02 a day against 0.12 a miss, so it rescues the next person, not him.
...
`prototype.html` is the two screens above: Okafor's console the morning the
alert fires, and The Undertow's phone answering what he asked on 26 August. A
mock, not a build.
